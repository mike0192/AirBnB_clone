#!/usr/bin/python3
"""Module for unittesting city model"""
...
class TestCity_to_dict(unittest.TestCase):
    """Class for Unittesting to_dict method of the City class"""
    ...
    def test_to_dict_output(self):
        ...
        cty = City()
        cty.id = "123456"
        cty.created_at = cty.updated_at = date
        tdict = {
            'id': '123456',
            '__class__': 'City',
...
class TestCity_init(unittest.TestCase):
    """class for unittesting instantiation of the City class"""
    ...
    def test_str_representation(self):
        ...
        self.assertIn("'created_at': " + date_repr, ctystr)
        self.assertIn("'updated_at': " + date_repr, ctystr)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        cty = City(id="345", created_at=date_iso, updated_at=date_iso)
...
class TestCity_save(unittest.TestCase):
    """CLass for unittesting save method of the City class"""
