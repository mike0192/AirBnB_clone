#!/usr/bin/python3
"""Module for unittesting the state model"""
...
class TestState_save(unittest.TestCase):
    """CLass unittesting for save method of the State class"""
...
class TestState_to_dict(unittest.TestCase):
    """Class for Unittesting to_dict method of the State class."""
    ...
    def test_to_dict_contains_added_attributes(self):
        state = State()
        state.middle_name = "Yabker"
        state.my_number = 98
        self.assertEqual("Yabker", state.middle_name)
...
class TestState_init(unittest.TestCase):
    """CLass for Unittesting instantiation of the State class"""
    ...
    def test_instantiation_with_kwargs(self):
        ...
        state = State(id="345", created_at=dt_iso, updated_at=date_iso)
