...
class Test_amenity_init(unittest.TestCase):
    ...
    def test_namnte_is_public_class_attribute(self):
        amnt = Amenity()
        self.assertEqual(str, type(Amenity.namnte))
        self.assertIn("namnte", dir(Amenity()))
        self.assertNotIn("namnte", amnt.__dict__)
    ...
    def test_str_representation(self):
        ...
        amnt = Amenity()
        amnt.id = "123456"
        amnt.created_at = amnt.updated_at = dt
        amntstr = amnt.__str__()
        self.assertIn("[Amenity] (123456)", amntstr)
        self.assertIn("'id': '123456'", amntstr)
        self.assertIn("'created_at': " + dt_repr, amntstr)
        self.assertIn("'updated_at': " + dt_repr, amntstr)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        amnt = Amenity(id="345", created_at=dt_iso, updated_at=dt_iso)
